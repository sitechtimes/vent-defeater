...
function attack(element: GameElement | undefined, rowIndex: number, numIndex: number) {
  ...
  function ice(element: GameElement, rowIndex: number, numIndex: number) {
  ...
  function fire(element: GameElement, rowIndex: number, numIndex: number) {
    if (store.energy < (relics[1].unlocked ? 6 : relics[0].unlocked ? 4 : 5)) return emit("outOfEnergy");
  ...
  function earth(element: GameElement, rowIndex: number, numIndex: number) {
    if (store.energy < (relics[1].unlocked ? 6 : relics[0].unlocked ? 4 : 5)) return emit("outOfEnergy");
    if (elementGrid.value[rowIndex][numIndex] != 0) return;
